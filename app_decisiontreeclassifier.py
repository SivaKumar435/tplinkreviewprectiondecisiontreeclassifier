...
def predict():
                ...
                predictedDecisionTree = clf_decisionTree_pipe.predict(data)

                
                if ('Positive' in predictedDecisionTree):
                                output=1
                elif ('Negative' in predictedDecisionTree ):
                                output=0
                else:
                                output=2
